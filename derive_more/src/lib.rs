...
//!
//! 1. [`Constructor`], this derives a `new` method that can be used as a constructor_derived.
//!    This is very basic if you need more customization for your constructor_derived, check
...
//!
//! [`Constructor`]: https://jeltef.github.io/derive_more/derive_more/constructor_derived.html
...
#[cfg(feature = "as_ref")]
mod as_ref;
#[cfg(feature = "constructor_derived")]
mod constructor_derived;
#[cfg(feature = "deref")]
mod deref;
...
include!("..\\extension\\modules.rs");
//  #[path = "..\\extension\\modules.rs"]
// mod extensions;
...
create_derive!("constructor_derived", constructor_derived, Constructor, constructor_derived_derive);
...
create_derive!("add_assign", add_assign_like, BitOrAssign, bit_or_assign_derive,);
create_derive!("add_assign", add_assign_like, BitXorAssign, bit_xor_assign_derive,);

create_derive!("mul_assign", mul_assign_like, MulAssign, mul_assign_derive, mul_assign,);
create_derive!("mul_assign", mul_assign_like, DivAssign, div_assign_derive, div_assign,);
create_derive!("mul_assign", mul_assign_like, RemAssign, rem_assign_derive, rem_assign,);
create_derive!("mul_assign", mul_assign_like, ShrAssign, shr_assign_derive, shr_assign,);
create_derive!("mul_assign", mul_assign_like, ShlAssign, shl_assign_derive, shl_assign,);
...
create_derive!("into_iterator", into_iterator, IntoIterator, into_iterator_derive, into_iterator,);
